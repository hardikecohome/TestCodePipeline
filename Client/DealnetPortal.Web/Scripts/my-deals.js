                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            "render": function (sdata, type, row) {
                                return '<div class="edit-control"><a href="#" title="Edit"><svg aria-hidden="true" class="icon icon-edit"><use xlink:href="/client/Content/images/sprite/sprite.svg#icon-edit"></use></svg></a></div>';
                            }
                        }
                    ],
                    columnDefs: [
