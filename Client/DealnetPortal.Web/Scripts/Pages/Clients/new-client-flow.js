module.exports("new-client-flow",
    function(require) {
                ...
                return function(action) {
                    ...
                    if (state.activePanel === "contact-information") {
                        ...
                        if (index3 >= 0) {
                            ...
                            if (action.type === clientActions.SET_PHONE) {
                                var homePhone = contactInfoFlow.indexOf(clientActions.SET_CELL_PHONE);
                                if (homePhone >= 0) {
                                    contactInfoFlow.splice(homePhone, 1);
                                }
                            }
                            if (action.type === clientActions.SET_CELL_PHONE) {
                                var cellPhone = contactInfoFlow.indexOf(clientActions.SET_PHONE);
                                if (cellPhone >= 0) {
                                    contactInfoFlow.splice(cellPhone, 1);
                                }
                            }
                        }
