...
namespace DealnetPortal.Web.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        {
            var contracts = (completedOnly ?? false ? await _contractServiceAgent.GetCompletedContracts() : await _contractServiceAgent.GetContracts()).OrderBy(x => x.IsCreatedByCustomer).ThenBy(x => x.LastUpdateTime).ToList();
