...
namespace DealnetPortal.Web.Models
{
    public class ApplicantPersonalInfo
    {
        ...
        [RegularExpression(@"^[a-zA-Z \.‘`-]+$", ErrorMessage = "First Name is in incorrect format")]
        public string FirstName { get; set; }
        [Required]
        [Display(Name = "Last Name")]
        [StringLength(20, MinimumLength = 2)]
        [RegularExpression(@"^[a-zA-Z \.‘`-]+$", ErrorMessage = "Last Name is in incorrect format")]
    ...
    public class AddressInformation
    {
        ...
        [RegularExpression(@"^[a-zA-Z0-9 \.‘`-]+$", ErrorMessage = "Installation Address is in incorrect format")]
        ...
        [RegularExpression(@"^[a-zA-Z \.‘`-]+$", ErrorMessage = "City is in incorrect format")]
        public string City { get; set; }
        [Required]
        [StringLength(30, MinimumLength = 2)]
        [RegularExpression(@"^[a-zA-Z \.‘`-]+$", ErrorMessage = "Province is in incorrect format")]
