    ...
    public class AutoMapperConfig
    {
        ...
        private static void MapVMsToModels(IMapperConfigurationExpression cfg)
        {
            ...
            cfg.CreateMap<EquipmentInformationViewModel, EquipmentInfoDTO>()
                ...
                {
                    if(d.PreferredInstallDate.HasValue)
                    {
                        var installationTime = DateTime.ParseExact(d.PreferredInstallTime, "HHmm",
                            DateTimeFormatInfo.InvariantInfo);
                        return d.PreferredInstallDate.Value.AddHours(installationTime.Hour);
                    }
                    return d.PreferredInstallDate;
                }))
            ...
            cfg.CreateMap<HelpPopUpViewModal, SupportRequestDTO>()
                ...
                .ForMember(x => x.BestWay, d => d.MapFrom(src => src.BestWayToContact.ConvertTo<Api.Common.Enumeration.PreferredContactMethod>()))
                .ForMember(x => x.ContactDetails, d => d.ResolveUsing(src =>
                    src.BestWayToContact == Models.Enumeration.PreferredContactType.Phone ? src.Phone : src.Email));
        ...
        private static void MapModelsToVMs(IMapperConfigurationExpression cfg)
        {
            ...
            cfg.CreateMap<EquipmentInfoDTO, EquipmentInformationViewModel>()
                ...
                .ForMember(x => x.LoanDeferralType, d => d.ResolveUsing(src =>
                    src.AgreementType == Api.Common.Enumeration.AgreementType.LoanApplication
                        ? src.DeferralType.ConvertTo<LoanDeferralType>()
                        : 0))
            ...
            cfg.CreateMap<CustomerRiskGroupDTO, CustomerRiskGroupViewModel>();
